                            ...
                            foreach ($row->result() as $key => $data) { ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" width="160px">
                                        <a href="<?= site_url('administrator/penerbit/edit/' . $data->id_penerbit) ?>" onclick="return confirm('Yakin ubah Produk')" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i> Ubah </a>
                                        <a href="<?= site_url('administrator/penerbit/del/' . $data->id_penerbit) ?>" onclick="return confirm('Yakin hapus Produk')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Hapus </a>
                                    </td>
                                </tr>
